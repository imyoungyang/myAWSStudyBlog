...
def input_fn(filenames, channel='training', batch_size=32, num_epochs=1, perform_shuffle=False):
    ...
    if FLAGS.pipe_mode == 0:
        ...
        dataset = dataset.apply(map_and_batch(decode_libsvm, batch_size=batch_size,num_parallel_batches=10))
...
def main(_):
    ...
    #liangaws:测试单个实例多个GPU/CPU使用tensorflow原生的MirroredStrategy
